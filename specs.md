...
expr = <span class="d">IfExp</span>(expr test, expr body, expr orelse)  
	 ...
	 | <span class="d">Call</span>(expr func, expr<span class="s">\*</span> args)  
	 ...
	 | <span class="d">List</span>(expr items, expr_context ctx)  
	 | <span class="d">Slice</span>(expr<span class="s">?</span> lower, expr<span class="s">?</span> upper, expr<span class="s">?</span> step)  
